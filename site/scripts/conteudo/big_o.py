...
out naturais().take(5)""", "lang": "df"},
 ...
 {"callout": {"tipo": "nota", "titulo": "O(?) não é erro", "texto": "Significa que a análise não conseguiu provar a ordem, não que o código esteja errado. Nos 234 exercícios da linguagem, zero ficam indeterminados."}},
