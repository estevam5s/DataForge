...
se o LED piscou, o caminho inteiro funciona.''', "lang": "bash"},
 ...
 {"list": [
   "**nenhuma porta:** o cabo é só de energia, ou falta o driver (CH340, CP2102) do clone;",
   "**Firmata não responde:** o firmware não está gravado — `dataforge iot carregar firmata --porta=…`;",
   "**a porta abre e fica muda:** o monitor serial da IDE está com ela aberta. Duas coisas não abrem a mesma porta, e nada na tela explica isso."]},
...
placa.fechar()''', "lang": "df"},
 ...
 {"table": {"head": ["Pinos (ESP32)", "O que o firmware oferece", "Por quê"], "rows": [
   ["6 a 11", "nada", "são a flash SPI do módulo"],
   ["34 a 39", "só entrada", "o chip não tem saída nem pull-up neles"],
   ["os demais", "entrada, saída, pull-up, PWM", "o que o core diz"]]}},
 {"code": '''adopt Arcane.IoT as IoT
