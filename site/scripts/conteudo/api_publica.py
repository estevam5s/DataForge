...
"blocos": [
 ...
 {"table": {"head": ["Endpoint", "Tamanho", "O que traz"], "rows": [
   ...
   ["`/api/modulos.json`", "166 KB", "75 módulos e **2079 símbolos**, com assinatura e resumo de cada um"],
   ["`/api/comandos.json`", "29 KB", "62 comandos da CLI, em 7 grupos, com opções, exemplos e apelidos"],
...
doc := API.openapi(minha_api, {"titulo": "Loja", "versao": "2.0"})""", "lang": "df"},
 ...
 {"cards": [
   ...
   {"href": "/docs/biblioteca", "title": "Biblioteca Arcane", "meta": "2079 símbolos", "desc": "O mesmo que /api/modulos.json, para ler."},
