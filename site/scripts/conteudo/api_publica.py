...
"blocos": [
 ...
 {"table": {"head": ["Endpoint", "Tamanho", "O que traz"], "rows": [
   ...
   ["`/api/modulos.json`", "112 KB", "54 módulos e **1623 símbolos**, com assinatura e resumo de cada um"],
...
doc := API.openapi(minha_api, {"titulo": "Loja", "versao": "2.0"})""", "lang": "df"},
 ...
 {"cards": [
   ...
   {"href": "/docs/biblioteca", "title": "Biblioteca Arcane", "meta": "1623 símbolos", "desc": "O mesmo que /api/modulos.json, para ler."},
