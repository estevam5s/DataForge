...
$"Ola, {nome}! Voce tem {idade} anos."` },
  {"p": "A segunda tem menos ruído, menos `+` e nenhum `str()` — a conversão é automática. Detalhes em [Interpolação](/fundamentos/interpolacao)."},
  {"h2": "Concatenação"},
...
Teclado         3     200.0`, lang: 'text', title: `saída` },
  {"h2": "Além do básico"},
  {"p": "Para caixas, tabelas desenhadas, slug, remoção de acentos e distância entre textos, veja [Arcane.Text](/biblioteca/text). Para validação e extração por padrão, [Arcane.Regex](/biblioteca/regex)."},
];
