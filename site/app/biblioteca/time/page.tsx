...
out Time.humanize(3725)`, title: `exemplo` },
  {"callout": {"tipo": "nota", "texto": "`add_months` grampeia no último dia válido: 31/01 + 1 mês = 28/02. A operação não é reversível — veja [Datas e horas](/tecnicas/datas)."}},
  {"p": "Guia com contexto e boas práticas: [Time](/tecnicas/datas)."},
  {"h2": "Funções (54)"},
