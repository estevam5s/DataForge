...
out nome, idade, altura, ativo, vazio` },
  ...
  {"h2": "Constantes"},
  {"p": "`steady` declara um valor imutável. Reatribuir é erro — detectado inclusive pelo [analisador estático](/tecnicas/analise-estatica), antes de executar."},
...
out le(), sombreia(), x` },
  ...
  {"h2": "Nomes válidos"},
  {"list": ["Começam com letra ou `_`, seguidos de letras, dígitos ou `_`", "São **sensíveis à caixa**: `total` e `Total` são nomes diferentes", "Não podem ser uma das [81 palavras reservadas](/referencia/palavras-reservadas)"]},
