...
const blocos: Bloco[] = [
  {"h2": "Os comandos"},
  {"table": {"head": ["Comando", "O que faz"], "rows": [["[`run`](/cli/run)", "executa um programa"], ["[`check`](/cli/check)", "análise estática: nomes, aridade, tipos"], ["[`test`](/cli/test)", "descobre e roda os testes"], ["[`fmt`](/cli/fmt)", "formata o código"], ["[`lint`](/cli/lint)", "aponta problemas de estilo"], ["[`doc`](/cli/doc)", "gera documentação Markdown"], ["[`init`](/cli/init)", "cria um projeto novo"], ["[`repl`](/cli/repl)", "console interativo"], ["`info`", "mostra o manifesto do projeto"], ["`new`", "cria a partir de um template"], ["`tokens`", "mostra o fluxo de tokens (lexer)"], ["`ast`", "mostra a árvore sintática (parser)"], ["`version`", "mostra a versão"]]}},
