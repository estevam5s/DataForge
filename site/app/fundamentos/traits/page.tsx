...
blueprint Detalhado(nome) with Descritivel:
  ...
  {"callout": {"tipo": "atencao", "titulo": "O contrato não é verificado", "texto": "Um blueprint pode declarar `with Serializavel` sem implementar `serializar`, e nada reclama — até alguém chamar. Verificar isso na declaração está no [roadmap](/roadmap)."}},
