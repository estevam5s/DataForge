...
out r, r.area(), r.escalar(2)` },
  ...
  { code: `match fig:
    ...
    point Retangulo:
        yield "retangulo"` },
  {"p": "`point Retangulo(l, a)` faz três coisas de uma vez: verifica o tipo, extrai os campos e liga cada um a um nome. Veja [Pattern matching](/fundamentos/pattern-matching)."},
  {"h2": "Desestruturar"},
  { code: `{nome, idade} := u
out nome, idade` },
];
