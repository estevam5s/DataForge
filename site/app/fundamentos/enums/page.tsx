...
given pedido["status"] is "Publicado":     # nunca entra: caixa diferente` },
  {"p": "Um erro de digitação vira um `no` silencioso. Com enum, `Status.Publicad` é erro na hora — e o [`dataforge check`](/cli/check) acha antes mesmo de rodar:"},
