...
export const metadata: Metadata = {
  ...
  description:
    'Linguagem interpretada de propósito geral: lexer, parser, analisador estático e interpretador próprios, em Python, sem dependências no runtime. 58 módulos de biblioteca padrão e 257 exercícios verificados.',
