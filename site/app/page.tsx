...
export const metadata: Metadata = {
  ...
  description:
    'Linguagem interpretada de propósito geral: lexer, parser, analisador estático e interpretador próprios, em Python, sem dependências no runtime. 54 módulos de biblioteca padrão e 253 exercícios verificados.',
