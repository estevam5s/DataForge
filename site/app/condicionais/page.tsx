...
out dia(1), dia(3), dia(9)` },
  ...
  { code: `action tipo(n):
    match n:
        ...
        default:
            yield "outro"` },
  {"p": "O `match` do DataForge vai muito além de comparar valores — ele desmonta estruturas, testa tipos e aceita guardas. Isso está em [Pattern matching](/fundamentos/pattern-matching)."},
