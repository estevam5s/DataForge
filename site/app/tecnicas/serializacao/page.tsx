...
Serde.from_json_lines(texto)` },
  {"p": "O formato de log e de exportação em lote: cada linha é independente, então dá para processar em [stream](/tecnicas/streams) sem carregar o arquivo inteiro."},
  {"h2": "Outros formatos"},
  ...
  {"p": "A lista completa está em [Arcane.Serialization](/biblioteca/serialization)."},
];
