...
action buscar_todos():
  ...
  { code: `action emprestar(livro_id, leitor):
    ...
    ...` },
  {"p": "\"Um livro só pode estar emprestado uma vez\" depende do estado atual — não dá para validar sem consultar. Por isso essa checagem fica na camada de persistência, não nas [regras puras](/tecnicas/projeto)."},
  {"h2": "Introspecção"},
