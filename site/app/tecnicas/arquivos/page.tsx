...
cycle linha in IO.read("dados.txt").lines():
    processar(linha)` },
  {"callout": {"tipo": "atencao", "texto": "`IO.read` carrega o arquivo inteiro na memória. Para arquivos grandes, prefira um [`stream action`](/tecnicas/streams) que emite linha por linha."}},
...
IO.delete(caminho)` },
  ...
  { code: `action processar():
    ...
    yield resultado` },
  {"p": "Detalhes em [Tratamento de erros](/erros)."},
