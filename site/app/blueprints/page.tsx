...
blueprint Produto(nome, preco) with Serializavel, Comparavel:
  ...
  {"callout": {"tipo": "atencao", "texto": "O contrato **ainda não é verificado**: um blueprint pode declarar `with Serializavel` sem implementar `serializar`, e nada reclama até alguém chamar. Use `has_method(x, \"nome\")` quando isso importar. Está no [roadmap](/roadmap)."}},
...
out get_mro(p)             # ordem de resolução de métodos` },
  ...
  {"p": "Detalhes em [Records](/fundamentos/records)."},
];
