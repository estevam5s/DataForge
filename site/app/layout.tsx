...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 62 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 62 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 261 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '62 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 190 páginas, 261 exercícios que verificam o próprio ' +
