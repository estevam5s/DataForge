...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 58 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 58 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 257 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '58 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 190 páginas, 257 exercícios que verificam o próprio ' +
