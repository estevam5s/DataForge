...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 76 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 76 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '76 módulos de biblioteca padrão (Arcane)',
