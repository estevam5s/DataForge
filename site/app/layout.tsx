...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 75 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 75 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '75 módulos de biblioteca padrão (Arcane)',
