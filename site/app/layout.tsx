...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 87 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 87 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '87 módulos de biblioteca padrão (Arcane)',
