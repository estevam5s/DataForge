...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 79 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 79 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '79 módulos de biblioteca padrão (Arcane)',
