...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 71 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 71 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 267 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '71 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 190 páginas, 267 exercícios que verificam o próprio ' +
