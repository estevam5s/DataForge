...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 47 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 47 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '47 módulos de biblioteca padrão (Arcane)',
