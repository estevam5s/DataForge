...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 63 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 63 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 262 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '63 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 190 páginas, 262 exercícios que verificam o próprio ' +
