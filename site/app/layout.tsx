...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 66 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 66 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 264 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '66 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 190 páginas, 264 exercícios que verificam o próprio ' +
