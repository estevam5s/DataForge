...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 60 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 60 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 258 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '60 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 190 páginas, 258 exercícios que verificam o próprio ' +
