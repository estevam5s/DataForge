...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 89 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 89 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 399 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '89 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 460 páginas, 399 exercícios que verificam o próprio ' +
