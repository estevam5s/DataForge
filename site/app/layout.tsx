...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 86 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 86 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 397 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '86 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 460 páginas, 397 exercícios que verificam o próprio ' +
