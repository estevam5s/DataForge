...
const DESCRICAO_CURTA =
  ...
  'analisador estático, 46 módulos de biblioteca, dois frameworks web e ' +
...
const DESCRICAO_LONGA =
  ...
  'Traz 46 módulos de biblioteca padrão (Arcane), o framework web Kiln, ' +
  ...
  'Tudo o que a documentação afirma é código que roda: 237 exercícios que ' +
  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        '46 módulos de biblioteca padrão (Arcane)',
    ...
    },
    {
      ...
      description:
        'Mais de 190 páginas, 237 exercícios que verificam o próprio ' +
