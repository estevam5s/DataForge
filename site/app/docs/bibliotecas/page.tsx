...
`, lang: 'bash' },
  ...
  {"h2": "A vida depois do 1.0"},
  {"p": "Obsolescência com aviso, recurso experimental, changelog, licença, dependências e o guia de migração — o que decide se alguém consegue continuar usando a sua biblioteca."},
  {"cards": [{"href": "/docs/bibliotecas/obsolescencia", "title": "Marcar o que vai sumir", "desc": "Arcane.Evolucao.obsoleta — a ação continua funcionando, e quem a chama é avisado uma vez."}, {"href": "/docs/bibliotecas/experimental", "title": "API experimental", "desc": "Marcar o que ainda pode mudar sem aviso de versão — e por que isso protege os dois lados."}, {"href": "/docs/bibliotecas/changelog", "title": "O CHANGELOG", "desc": "O que escrever, em que ordem, e a seção que quase todo mundo esquece."}, {"href": "/docs/bibliotecas/licenca", "title": "Licença", "desc": "Por que uma biblioteca sem licença não pode ser usada, e o que cada família permite."}, {"href": "/docs/bibliotecas/dependencias", "title": "Escolher dependências", "desc": "Cada dependência é uma promessa que você faz em nome de outra pessoa — as perguntas antes de adicionar."}, {"href": "/docs/bibliotecas/mensagens", "title": "Mensagens para quem não leu o código", "desc": "O erro de uma biblioteca é lido por quem a usa — o que ele precisa dizer, e o que nunca dizer."}, {"href": "/docs/bibliotecas/estabilidade", "title": "A promessa de estabilidade", "desc": "O que cada número de versão promete, escrito — e conferido pelo abi a cada release."}, {"href": "/docs/bibliotecas/migracao", "title": "Guia de migração", "desc": "Numa versão maior, o guia que diz a cada pessoa o que trocar — com a busca que acha cada uso."}, {"href": "/docs/bibliotecas/checklist", "title": "Checklist de release", "desc": "As doze conferências antes de uma tag — e o comando que faz cada uma."}]},
];

const headings = [{ id: 'em-trinta-segundos', text: "Em trinta segundos", level: 2 as const }, { id: 'as-quatro-bibliotecas-deste-repositorio', text: "As quatro bibliotecas deste repositório", level: 2 as const }, { id: 'o-que-distingue-uma-biblioteca-de-um-programa', text: "O que distingue uma biblioteca de um programa", level: 2 as const }, { id: 'a-vida-depois-do-10', text: "A vida depois do 1.0", level: 2 as const }];
