...
dataforge test     # roda tests/`, lang: 'bash' },
  ...
  {"h2": "Passo a passo"},
  {"p": "Dez páginas curtas, na ordem em que as dúvidas aparecem: do primeiro out ao primeiro programa inteiro."},
  {"cards": [{"href": "/docs/primeiros-passos/ola-mundo", "title": "1. Olá, mundo — de verdade", "desc": "O que acontece quando você roda um arquivo: a linha, a ordem, e o que 'out' faz."}, {"href": "/docs/primeiros-passos/variaveis-e-contas", "title": "2. Variáveis e contas", "desc": "Dar nome a um valor com :=, e as contas que a linguagem sabe fazer."}, {"href": "/docs/primeiros-passos/entrada", "title": "3. Perguntar ao usuário", "desc": "input(): ler o que a pessoa digita, converter em número, e o fim da entrada."}, {"href": "/docs/primeiros-passos/decisoes", "title": "4. Decidir", "desc": "given, orif e otherwise — e as comparações que decidem."}, {"href": "/docs/primeiros-passos/repeticao", "title": "5. Repetir", "desc": "cycle para contar e percorrer, persist para repetir enquanto for verdade."}, {"href": "/docs/primeiros-passos/colecoes", "title": "6. Listas, vaults e conjuntos", "desc": "Guardar muitos valores: a lista em ordem, o vault por nome, o conjunto sem repetição."}, {"href": "/docs/primeiros-passos/acoes", "title": "7. Ações — dar nome a um pedaço de código", "desc": "action, parâmetros e yield: escrever uma vez, usar em qualquer lugar."}, {"href": "/docs/primeiros-passos/primeiro-programa", "title": "8. O primeiro programa completo", "desc": "Um jogo de adivinhar o número — com a lógica separada da conversa, e testada."}, {"href": "/docs/primeiros-passos/erros-comuns", "title": "9. Ler uma mensagem de erro", "desc": "Onde olhar numa mensagem de erro, e os seis erros que quem começa mais encontra."}, {"href": "/docs/primeiros-passos/proximos-passos", "title": "10. Para onde ir agora", "desc": "Os caminhos depois do básico — conforme o que você quer construir."}]},
