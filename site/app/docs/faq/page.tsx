...
const blocos: Bloco[] = [
  ...
  {"p": "Depende do que \"produção\" significa no seu caso. O que existe e é testado: mais de 1300 testes, 227 exercícios, 44 exemplos, análise estática, servidor HTTP e SQLite funcionando."},
  ...
  {"p": "É um interpretador de árvore, então mais lento que Python — que já é lento perto de uma linguagem compilada. Um `fib(25)` leva 1,28 s onde o CPython leva 0,03 s."},
  {"p": "O corpo das ações é **compilado para fechamentos** na primeira execução: a árvore vira funções Python, o que tira o despacho do caminho quente. Medido, de 1,23× a 1,80× conforme a carga."},
  {"callout": {"tipo": "nota", "titulo": "Por que não uma VM de bytecode", "texto": "Ela foi medida antes de descartada: um protótipo em Python deu 7,9×, e o de fechamentos preservando a semântica inteira deu 6,5×. Mesma ordem de grandeza, e nenhum dos dois fecha uma diferença de 40× — fechá-la exigiria sair do Python, e isso custaria a promessa de zero dependências. Se você tem um caso real onde a velocidade impede o uso, é a melhor forma de priorizar o assunto."}},
