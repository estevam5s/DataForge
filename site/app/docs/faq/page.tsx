...
const blocos: Bloco[] = [
  ...
  {"p": "Depende do que \"produção\" significa no seu caso. O que existe e é testado: mais de 1300 testes, 258 exercícios, 44 exemplos, análise estática, servidor HTTP e SQLite funcionando."},
