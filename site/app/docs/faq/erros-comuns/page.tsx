...
nao := 1       # certo` },
  {"p": "As que mais pegam em português: `no`, `in`, `is`, `to`, `from`, `as`, `step`, `point`, `default`, `frame`, `stream`, `emit`, `forge`. A [lista completa](/docs/referencia/palavras-reservadas) tem 81."},
