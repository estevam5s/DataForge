...
`, lang: 'df' },
  ...
  {"h2": "As decisões de uma API"},
  {"p": "Dez páginas sobre o que toda API HTTP acaba precisando decidir: o formato do erro, o tipo da resposta, a edição concorrente, a paginação, a versão, a idempotência, a autenticação, o limite e o contrato."},
  {"cards": [{"href": "/docs/api/problemas", "title": "Erros que um programa lê", "desc": "application/problem+json (RFC 9457): o tipo, o título, o detalhe — e por que texto de erro não é contrato."}, {"href": "/docs/api/negociacao", "title": "Negociação de conteúdo", "desc": "JSON ou CSV no mesmo endereço: o cabeçalho Accept, o q, o curinga — e quando responder 406."}, {"href": "/docs/api/precondicoes", "title": "Edição concorrente: ETag e If-Match", "desc": "Duas pessoas editam o mesmo recurso. Sem pré-condição, a segunda apaga a mudança da primeira — calada. Com ela, recebe 412."}, {"href": "/docs/api/paginacao", "title": "Paginação: página, cursor e Link", "desc": "Por que ?pagina=3 pula e repete itens numa lista que muda, como um cursor opaco resolve, e o cabeçalho Link."}, {"href": "/docs/api/versionamento", "title": "Versionar uma API", "desc": "Na URL ou no cabeçalho, o que obriga a subir a versão, e como aposentar uma com Deprecation e Sunset."}, {"href": "/docs/api/idempotencia", "title": "Idempotência", "desc": "A resposta se perde na rede e o cliente reenvia. Sem chave de idempotência, a cobrança acontece duas vezes."}, {"href": "/docs/api/autenticacao", "title": "Autenticação numa API", "desc": "Bearer token, 401 contra 403, o middleware que falha fechado, e o token assinado do próprio Kiln."}, {"href": "/docs/api/limites", "title": "Limite de taxa", "desc": "429, Retry-After e a janela deslizante — e por que o limite é por cliente, não global."}, {"href": "/docs/api/contrato", "title": "O contrato: OpenAPI", "desc": "O documento que Swagger, Postman e gerador de cliente leem — gerado das rotas, e conferido num teste."}, {"href": "/docs/api/checklist", "title": "Checklist de uma API", "desc": "Vinte perguntas antes de publicar — cada uma com a página que a responde."}]},
  {"h2": "Por onde seguir"},
