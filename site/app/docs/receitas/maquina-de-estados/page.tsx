...
assert invalida is yes, "transicao invalida bloqueada"`, title: `118_maquina_estados.df` },
  ...
  {"p": "Com `\"publicado\"` como texto solto, um erro de digitação vira um `no` silencioso. Com [enum](/docs/fundamentos/enums), é erro na hora — e o `check` acha antes de rodar."},
];
...
export default function Pagina() {
  return (
    <DocPage
      title={"Máquina de estados"}
      description={"Um enum, uma tabela de transições e nenhum estado inválido representável."}
      href={"/docs/receitas/maquina-de-estados"}
      headings={headings}
    >
