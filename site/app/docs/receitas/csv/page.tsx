...
assert contagem["TI"] is 3, "TI aparece 3x"`, title: `105_dados_tabulares.df` },
  {"h2": "O fluxo"},
  {"p": "Ler o CSV, converter cada linha num record tipado, validar, agregar e reportar. Para arquivos grandes, o mesmo desenho vira um [pipeline de streams](/docs/tecnicas/streams)."},
  {"h2": "Serialização"},
