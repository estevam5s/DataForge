    ...
    >
      ...
      <Table
        ...
        rows={[
          ...
          [<>Biblioteca padrão</>, <>79 módulos, 2156 símbolos</>],
...
'no' is a reserved keyword and cannot be assigned to.
    sugestão: Pick another name.`}
      ...
      <p>
        ...
        <strong>4793 testes</strong>, 387 exercícios que verificam o próprio
...
dataforge version`}
      ...
      <CardGrid>
        ...
        <Card href="/docs/biblioteca" title="Biblioteca Arcane" meta="2156 símbolos">
