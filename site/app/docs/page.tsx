    ...
    >
      ...
      <Table
        ...
        rows={[
          ...
          [<>Biblioteca padrão</>, <>46 módulos, 1492 símbolos</>],
...
'no' is a reserved keyword and cannot be assigned to.
    sugestão: Pick another name.`}
      ...
      <p>
        ...
        <strong>2546 testes</strong>, 240 exercícios que verificam o próprio
...
dataforge version`}
      ...
      <CardGrid>
        ...
        <Card href="/docs/biblioteca" title="Biblioteca Arcane" meta="1492 símbolos">
