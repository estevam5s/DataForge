...
const DESCRICAO =
  'A documentação do DataForge: mais de 190 páginas, 265 exercícios que ' +
    ...
    >
      ...
      <Table
        ...
        rows={[
          ...
          [<>Biblioteca padrão</>, <>68 módulos, 1853 símbolos</>],
...
'no' is a reserved keyword and cannot be assigned to.
    sugestão: Pick another name.`}
      ...
      <p>
        ...
        <strong>3821 testes</strong>, 265 exercícios que verificam o próprio
        resultado com <code>assert</code>, e 44 programas de exemplo. Os
        trechos desta documentação são compilados a cada mudança — 1584 deles.
      </p>
...
dataforge version`}
      ...
      <CardGrid>
        ...
        <Card href="/docs/exercicios" title="265 exercícios" meta="46 áreas">
          Cada um se verifica com <code>assert</code>. Vinte e dois módulos têm
          um <code>.md</code> explicativo ao lado de cada exercício.
        </Card>
        <Card href="/docs/biblioteca" title="Biblioteca Arcane" meta="1853 símbolos">
