...
nums >> sift n: n % 2 is 1 >> morph n: n * 2` },
  {"table": {"head": ["Situação", "Prefira"], "rows": [["um filtro e uma transformação", "compreensão"], ["três ou mais estágios", "[pipeline](/docs/pipelines)"], ["duas fontes combinadas", "compreensão"], ["termina com uma redução", "pipeline (`distill`)"], ["lógica com vários passos", "laço `cycle`"]]}},
...
export default function Pagina() {
  return (
    <DocPage
      title={"Compreensões"}
      description={"Construir listas e vaults numa expressão, transformando e filtrando."}
      href={"/docs/fundamentos/compreensoes"}
      headings={headings}
    >
