...
lambda (n: Integer): n + 1                   # lambda (exige parênteses)` },
  {"p": "Anotar é **opcional**. O código funciona sem, mas quando presente a anotação é verificada — pelo interpretador e pelo [`dataforge check`](/docs/cli/check)."},
...
quantidade: Integer := 3.5     # erro — 3.5 não é inteiro` },
  ...
  {"p": "DataForge 4.0 ainda não tem `Cluster<Float>` — [generics](/docs/roadmap) estão no roadmap. Enquanto isso, o conteúdo se valida com código:"},
