...
export const metadata: Metadata = {
  title: "CLI",
  description: "Os 66 comandos do dataforge, do catálogo que o próprio help lê.",
};

const blocos: Bloco[] = [
  {"p": "`dataforge` — ou `df`, o mesmo programa — tem **66 comandos** em sete grupos. Esta tabela sai do catálogo que o próprio `dataforge help` lê: ela não tem como ficar para trás."},
