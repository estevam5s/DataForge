...
dataforge palavras cycle                             # so o que fala de laco`, lang: 'bash' },
  ...
  {"h3": "idioma"},
  {"p": "Os idiomas em que a linguagem fala, e quanto de cada um existe."},
  { code: `dataforge idioma [codigo]`, lang: 'bash' },
  { code: `A camada de idioma traduz as mensagens NA HORA DE DESENHAR: o texto nasce em ingles, e 'e.message' — o que um 'handle' compara — fica como nasceu.

Um catalogo por arquivo, em 'dataforge/idiomas/'. DF_IDIOMA_CAMINHO aponta uma pasta com catalogos de fora, e eles entram no registro como os de dentro — e um catalogo quebrado nao derruba nada: ele e ignorado, e aparece aqui com o motivo.

O que nao tem traducao sai em INGLES. Ninguem traduz 530 mensagens numa tacada, e um erro e mais util legivel em ingles que ilegivel na lingua certa.`, lang: 'text' },
  { code: `dataforge idioma                                     # os idiomas, com a cobertura
dataforge idioma es                                  # so o espanhol, em detalhe
DF_IDIOMA=es dataforge run x.df                      # rodar em espanhol`, lang: 'bash' },
  {"p": "Também: `lang`, `idiomas`. Veja: `erros`, `explain`."},
  {"h3": "erros"},
