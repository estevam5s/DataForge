...
const blocos: Bloco[] = [
  {"p": "São **225 funções e constantes** disponíveis sem nenhum `adopt`. Para o que está além disso, veja a [Biblioteca Arcane](/docs/biblioteca)."},
...
export default function Pagina() {
  return (
    <DocPage
      title={"Funções embutidas"}
      description={"As 225 funções e constantes globais, disponíveis sem import."}
      href={"/docs/referencia/embutidas"}
      headings={headings}
    >
