...
const blocos: Bloco[] = [
  ...
  {"callout": {"tipo": "dica", "texto": "Use o **executável** para escrever programas em DataForge; use o **Python** para contribuir com a linguagem. Os dois rodam exatamente o mesmo interpretador — os 264 exercícios e os 44 exemplos passam pelos dois."}},
...
python3 exercicios/run_all.py        # 264 exercícios`, lang: 'bash' },
  {"h2": "Problemas comuns"},
