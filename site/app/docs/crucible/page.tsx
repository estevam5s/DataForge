...
dataforge crucible --matchers           # lista os 59`, lang: 'bash' },
  {"h2": "Por onde seguir"},
  {"cards": [{"href": "/docs/crucible/matchers", "title": "Os 79 matchers", "desc": "igualdade, tipos, coleções, erros, desempenho"}, {"href": "/docs/crucible/fixtures", "title": "Fixtures e ganchos", "desc": "preparo, limpeza e por que elas ficam juntas"}, {"href": "/docs/crucible/dubles", "title": "Dublês", "desc": "mock, spy e stub — e a diferença entre eles"}, {"href": "/docs/crucible/propriedades", "title": "Teste por propriedade", "desc": "a regra em vez dos casos, com contraexemplo encolhido"}, {"href": "/docs/crucible/relatorios", "title": "Relatórios e CI", "desc": "texto, JUnit, JSON, TAP — e benchmark com p95"}, {"href": "/docs/crucible/cenarios", "title": "Cenários", "desc": "concorrência, relógio que anda, e um HTTP que você controla"}, {"href": "/docs/crucible/mutacao", "title": "Contratos e mutação", "desc": "o mesmo teste em duas implementações, e se o teste testa mesmo"}]},
];
