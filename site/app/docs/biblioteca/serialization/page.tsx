...
// 'site/scripts/conteudo_biblioteca/serialization.py'; as tabelas saem do
...
export const metadata: Metadata = {
  ...
  description: "JSON, CSV, INI, TOML, XML e conversões entre eles.",
};
...
out Serde.to_toml(dados)`, title: `exemplo` },
  {"p": "Guia com contexto e boas práticas: [Serialization](/docs/tecnicas/serializacao)."},
  {"h2": "Funções (26)"},
...
export default function Pagina() {
  return (
    <DocPage
      title={"Arcane.Serialization"}
      description={"JSON, CSV, INI, TOML, XML e conversões entre eles."}
      href={"/docs/biblioteca/serialization"}
      headings={headings}
    >
