...
export const metadata: Metadata = {
  ...
  description: "Vinte e nove módulos e 1016 símbolos, sem uma única dependência externa.",
};
...
const headings = [{ id: 'importar', text: "Importar", level: 2 as const }, { id: 'os-vinte-e-nove-modulos', text: "Os vinte e nove módulos", level: 2 as const }, { id: 'sem-dependencias', text: "Sem dependências", level: 2 as const }, { id: 'alem-dos-modulos', text: "Além dos módulos", level: 2 as const }];
