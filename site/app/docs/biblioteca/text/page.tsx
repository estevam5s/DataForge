...
// 'site/scripts/conteudo_biblioteca/text.py'; as tabelas saem do
...
export const metadata: Metadata = {
  title: "Arcane.Text",
  description: "Manipulação de texto, formatação, tabelas e conversão de caixa.",
};
