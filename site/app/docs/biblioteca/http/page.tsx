...
// 'site/scripts/conteudo_biblioteca/http.py'; as tabelas saem do
...
export const metadata: Metadata = {
  title: "Arcane.Http",
  description: "Servidor HTTP: rotas, middleware, JSON, arquivos estáticos.",
};
...
Http.listen(app, 3000)`, title: `exemplo` },
  {"callout": {"tipo": "nota", "texto": "`Http.listen` bloqueia: ele fica servindo até você interromper. Guia completo em [Servidor HTTP](/docs/tecnicas/http)."}},
  {"p": "Guia com contexto e boas práticas: [Http](/docs/tecnicas/http)."},
  {"h2": "Funções (17)"},
