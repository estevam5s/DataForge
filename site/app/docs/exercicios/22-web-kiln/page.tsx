...
const blocos: Bloco[] = [
  ...
  {"h2": "Os exercícios"},
  {"table": {"head": ["#", "Título", "Enunciado"], "rows": [["191", "**O primeiro servidor**", "declare um servidor com duas rotas e responda texto e HTML."], ["192", "**Parametros de caminho e query string**", "leia :id do caminho e ?campo= da query."], ["193", "**Uma API RESTful completa**", "os cinco verbos sobre um mesmo recurso, com os status certos."], ["194", "**Paginas HTML com template**", "renderize uma pagina a partir de um template com laco."], ["195", "**Middleware, autenticacao e limite de taxa**", "proteja rotas e limite pedidos por IP."], ["196", "**Paginas de erro, redirecionamento e arquivos estaticos**", "personalize o 404, redirecione uma rota antiga e sirva CSS."], ["197", "**Subir o servidor de verdade**", "acenda o forno, faca um pedido pela rede e apague."], ["198", "**A API vista de fora: OpenAPI, Insomnia e curl**", "exporte as rotas de um servidor Kiln para as ferramentas"]]}},
