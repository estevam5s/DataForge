...
export const metadata: Metadata = {
  title: "Exercícios",
  description: "260 exercícios em 42 módulos, cada um verificando o próprio resultado.",
};
...
const blocos: Bloco[] = [
  ...
  { code: `python3 exercicios/run_all.py          # todos os 260
