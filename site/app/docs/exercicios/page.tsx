...
export const metadata: Metadata = {
  title: "Exercícios",
  description: "266 exercícios em 48 módulos, cada um verificando o próprio resultado.",
};
...
const blocos: Bloco[] = [
  ...
  { code: `python3 exercicios/run_all.py          # todos os 266
