...
export const metadata: Metadata = {
  title: "Exercícios",
  description: "237 exercícios em 34 módulos, cada um verificando o próprio resultado.",
};
...
const blocos: Bloco[] = [
  ...
  { code: `python3 exercicios/run_all.py          # todos os 237
