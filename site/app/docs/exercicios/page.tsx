...
export const metadata: Metadata = {
  title: "Exercícios",
  description: "259 exercícios em 41 módulos, cada um verificando o próprio resultado.",
};
...
const blocos: Bloco[] = [
  ...
  { code: `python3 exercicios/run_all.py          # todos os 259
