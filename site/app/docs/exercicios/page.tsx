...
export const metadata: Metadata = {
  title: "Exercícios",
  description: "218 exercícios em 27 módulos, cada um verificando o próprio resultado.",
};
...
const blocos: Bloco[] = [
  ...
  { code: `python3 exercicios/run_all.py          # todos os 218
...
dataforge run exercicios/01-fundamentos/001_ola_mundo.df`, lang: 'bash' },
  ...
  {"callout": {"tipo": "nota", "titulo": "Eles rodam a cada mudança", "texto": "Os 218 são executados na suíte do repositório. Um exercício que quebrasse com uma mudança na linguagem apareceria no mesmo instante — é por isso que os exemplos desta documentação podem ser citados sem medo."}},
  {"h2": "Os 27 módulos"},
