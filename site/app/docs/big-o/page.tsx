...
const blocos: Bloco[] = [
  ...
  {"cards": [{"href": "/docs/big-o/recorrencias", "title": "Recorrências e Teorema Mestre", "desc": "como se resolve o custo de uma função que chama a si mesma"}, {"href": "/docs/big-o/amortizada", "title": "Análise amortizada", "desc": "por que 'append' é O(1) mesmo copiando a lista de vez em quando"}, {"href": "/docs/big-o/limites", "title": "Ω, Θ e limites inferiores", "desc": "o que algoritmo nenhum pode fazer melhor — e como escapar disso"}, {"href": "/docs/big-o/estruturas-avancadas", "title": "Estruturas avançadas", "desc": "heap, união-busca, deque e contador, com o custo de cada uma"}, {"href": "/docs/big-o/paralelo", "title": "Complexidade em paralelo", "desc": "trabalho, profundidade e o teto de Amdahl — medido"}, {"href": "/docs/big-o/constantes", "title": "A constante que decide", "desc": "quando o melhor no papel perde na máquina, com medição"}, {"href": "/docs/big-o/dados", "title": "Complexidade em dados e I/O", "desc": "banco, disco e rede: quando a unidade de custo deixa de ser a operação"}]},
  {"h2": "Algoritmos, na prática"},
  {"p": "Da teoria ao algoritmo que você chama: `Arcane.Algoritmos` traz catorze clássicos, cada um com a complexidade que promete — e estas páginas mostram quando escolher cada um."},
  {"cards": [{"href": "/docs/big-o/algoritmos", "title": "Os clássicos, prontos", "desc": "Arcane.Algoritmos — catorze algoritmos com a complexidade declarada, e conferidos contra a versão ingênua."}, {"href": "/docs/big-o/busca", "title": "Busca", "desc": "Linear, binária e por hash — as três respostas para 'está aqui?', e o que cada uma exige."}, {"href": "/docs/big-o/ordenacao", "title": "Ordenação", "desc": "Por comparação é O(n log n) no melhor caso; por contagem, O(n + k) — e o que é estabilidade."}, {"href": "/docs/big-o/grafos", "title": "Grafos", "desc": "BFS, DFS, ordem topológica e Dijkstra — O(V + E) e O((V + E) log V), e o que cada um responde."}, {"href": "/docs/big-o/programacao-dinamica", "title": "Programação dinâmica", "desc": "Trocar exponencial por polinomial guardando subproblemas — LCS, Levenshtein e a mochila."}, {"href": "/docs/big-o/texto", "title": "Texto e números", "desc": "KMP acha um padrão em O(n + m); o crivo acha os primos em O(n log log n)."}, {"href": "/docs/big-o/escolher", "title": "Escolher a estrutura", "desc": "Uma tabela de decisão: a pergunta que o código faz mais vezes decide a estrutura."}, {"href": "/docs/big-o/medir", "title": "Medir a curva", "desc": "Bench.curva e Bench.classe — a classe MEDIDA, com a honestidade de dizer quando a medida não separa duas."}, {"href": "/docs/big-o/exercicios", "title": "Exercícios de complexidade", "desc": "Oito trechos para classificar — e a resposta, com o porquê, conferida pelo próprio analisador."}]},
];

const headings = [{ id: 'as-curvas', text: "As curvas", level: 2 as const }, { id: 'o-que-cada-classe-custa', text: "O que cada classe custa", level: 2 as const }, { id: 'linear-contra-logaritmica-vendo', text: "Linear contra logarítmica, vendo", level: 2 as const }, { id: 'o-que-big-o-nao-diz', text: "O que Big-O não diz", level: 2 as const }, { id: 'por-onde-seguir', text: "Por onde seguir", level: 2 as const }, { id: 'indo-mais-fundo', text: "Indo mais fundo", level: 2 as const }, { id: 'algoritmos-na-pratica', text: "Algoritmos, na prática", level: 2 as const }];
