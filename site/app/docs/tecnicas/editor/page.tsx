...
export const metadata: Metadata = {
  ...
  description: "Cores, erros enquanto se digita, autocompletar, depurador com breakpoints, Big-O acima de cada ação, 65 comandos e o painel de bancos. O que cada coisa faz, e por quê.",
};
