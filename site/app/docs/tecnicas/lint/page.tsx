...
const blocos: Bloco[] = [
  {"h2": "O que ele faz"},
  {"p": "O `lint` encontra o que **compila mas provavelmente não é o que você quis dizer**. Não repete o que o [`check`](/docs/tecnicas/analise-estatica) já reporta: aqui moram questões de higiene e estilo."},
