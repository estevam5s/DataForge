...
`, lang: 'text' },
  {"p": "E os nomes do próprio arquivo vêm **antes** dos 1760 símbolos da stdlib — é o que se procura em nove de cada dez vezes."},
  {"h2": "O hover lê o seu comentário"},
  {"p": "DataForge não tem docstring. O costume — visível nos 260 exercícios e na stdlib inteira — é comentar **acima** da declaração, e é dali que o hover lê:"},
