...
// A fonte e 'site/scripts/conteudo/lsp.py' — mude la e rode o gerador.
...
const blocos: Bloco[] = [
  ...
  {"table": {"head": ["Recurso", "O que faz", "Atalho"], "rows": [["**Diagnóstico**", "erro e aviso sublinhados **enquanto se digita**, não só ao salvar", "—"], ["**Autocompletar**", "nomes do arquivo, embutidas, módulos e o que há dentro de cada um", "`Ctrl+Espaço`"], ["**Hover**", "a assinatura e o comentário que está acima da declaração", "parar o mouse"], ["**Ir para definição**", "salta para onde o nome foi declarado", "`F12`"], ["**Referências**", "onde mais aquele nome aparece", "`Shift+F12`"], ["**Esquema**", "ações, blueprints, records e enums na barra lateral", "`Ctrl+Shift+O`"], ["**Ajuda de assinatura**", "os parâmetros, enquanto se escreve a chamada", "ao abrir `(`"], ["**Renomear**", "troca o nome em todo o arquivo, recusando o que quebraria", "`F2`"], ["**Formatar**", "o mesmo `dataforge fmt`", "`Shift+Alt+F`"], ["**Correção rápida**", "aplica a sugestão do analisador", "`Ctrl+.`"]]}},
...
`, lang: 'text' },
  {"p": "E os nomes do próprio arquivo vêm **antes** dos 1167 símbolos da stdlib — é o que se procura em nove de cada dez vezes."},
  {"h2": "O hover lê o seu comentário"},
  {"p": "DataForge não tem docstring. O costume — visível nos 218 exercícios e na stdlib inteira — é comentar **acima** da declaração, e é dali que o hover lê:"},
...
(with-eval-after-load 'eglot
  ...
  {"table": {"head": ["Sintoma", "Provável causa"], "rows": [["Nenhum autocompletar", "o executável não está no `PATH` — veja o canal *DataForge* na saída do editor"], ["Erros em dobro", "o servidor **e** o check ao salvar ligados; o servidor desliga o segundo sozinho, mas uma extensão antiga em cache pode não fazer isso — reinstale com `dataforge editor`"], ["Parou de responder", "*DataForge: Reiniciar o servidor de linguagem*, na paleta de comandos"], ["Quero ver o que aconteceu", "aponte `dataforge.servidor.log` para um arquivo"]]}},
...
const headings = [{ id: 'o-que-ele-responde', text: "O que ele responde", level: 2 as const }, { id: 'autocompletar-sabe-onde-voce-esta', text: "Autocompletar sabe onde você está", level: 2 as const }, { id: 'o-hover-le-o-seu-comentario', text: "O hover lê o seu comentário", level: 2 as const }, { id: 'o-que-ele-recusa', text: "O que ele recusa", level: 2 as const }, { id: 'ele-sobrevive-ao-arquivo-pela-metade', text: "Ele sobrevive ao arquivo pela metade", level: 2 as const }, { id: 'outros-editores', text: "Outros editores", level: 2 as const }, { id: 'neovim', text: "Neovim", level: 3 as const }, { id: 'helix-em-languagestoml', text: "Helix — em `languages.toml`", level: 3 as const }, { id: 'emacs-com-eglot', text: "Emacs — com `eglot`", level: 3 as const }, { id: 'quando-algo-nao-funciona', text: "Quando algo não funciona", level: 2 as const }, { id: 'desligar', text: "Desligar", level: 2 as const }];
