...
`, lang: 'bash' },
  ...
  {"cards": [{"href": "/docs/testes/tdd", "title": "TDD", "desc": "vermelho, verde, refatorar — passo a passo"}, {"href": "/docs/testes/unitarios", "title": "Testes unitários", "desc": "preparar, agir, conferir; uma razão para falhar"}, {"href": "/docs/testes/parametrizados", "title": "Parametrizados", "desc": "uma tabela de casos, um corpo só"}, {"href": "/docs/testes/bdd", "title": "Cenários (BDD)", "desc": "dado, quando, então — e o passo que quebrou"}, {"href": "/docs/testes/integracao", "title": "Integração", "desc": "o banco de verdade e a rota inteira"}, {"href": "/docs/testes/ponta-a-ponta", "title": "Ponta a ponta", "desc": "subprocesso, código de saída, socket"}, {"href": "/docs/testes/erros", "title": "Testar erros", "desc": "o tipo, o valor e o que não ficou pela metade"}, {"href": "/docs/testes/regressao", "title": "Regressão", "desc": "todo bug vira teste; o instantâneo"}, {"href": "/docs/testes/piramide", "title": "A pirâmide", "desc": "quantos de cada, e o que não testar"}, {"href": "/docs/testes/instaveis", "title": "Testes instáveis", "desc": "as cinco causas, e por que repetir não corrige"}]},
