...
V.subir(porta := 8501)`, lang: 'df' },
  ...
  {"h2": "Onde continuar"},
  {"cards": [{"href": "/docs/vitrine/componentes", "title": "Componentes", "meta": "texto, entrada, dados", "desc": "Os 40 componentes, o que cada um devolve e quando usar formulário."}, {"href": "/docs/vitrine/layout", "title": "Layout", "meta": "colunas, abas, cartões", "desc": "Por que a área é um objeto, e não um bloco de contexto."}, {"href": "/docs/vitrine/estado", "title": "Estado e cache", "meta": "sessão, global, TTL, LRU", "desc": "Os três lugares onde um valor mora, e quem enxerga cada um."}, {"href": "/docs/vitrine/graficos", "title": "Gráficos", "meta": "sete tipos, em SVG", "desc": "A forma curta e a construída, e o que os dados precisam parecer."}, {"href": "/docs/vitrine/paginas", "title": "Páginas e segurança", "meta": "rotas, login, permissões", "desc": "Multipágina, parâmetros de URL, autenticação e autorização."}, {"href": "/docs/vitrine/acessibilidade", "title": "Acessibilidade e idioma", "meta": "ARIA, teclado, i18n", "desc": "O que já vem pronto para teclado e leitor de tela, e como traduzir."}, {"href": "/docs/vitrine/testes", "title": "Testes", "meta": "sem navegador", "desc": "A sonda clica, digita e pergunta — e o pedido HTTP sem socket."}, {"href": "/docs/vitrine/producao", "title": "Produção", "meta": "hot reload, métricas, plugins", "desc": "Subir, observar, e o que colocar na frente."}, {"href": "/docs/vitrine/projeto", "title": "Um projeto completo", "meta": "banco, ETL, painel, testes", "desc": "Análise de vendas de ponta a ponta, do CSV ao gráfico."}, {"href": "/docs/vitrine/referencia", "title": "Referência", "meta": "113 símbolos", "desc": "Tudo o que sai de `adopt Arcane.Vitrine`, em uma tabela."}]},
];
