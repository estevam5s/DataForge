...
// A fonte e 'site/scripts/conteudo/idiomas.py' — mude la e rode o gerador.
...
error[DF0401]: 'x' n'est pas défini.`, lang: 'bash' },
  {"table": {"head": ["Decisão", "Porque"], "rows": [["os **padrões** vêm do catálogo em português", "um regex copiado à mão casaria *quase*, e 'quase' aqui é uma mensagem que sai em inglês sem ninguém entender por quê"], ["os grupos são **nomeados**", "numerados, inverter dois campos numa tradução passaria calado"], ["um catálogo quebrado é **ignorado**", "um erro de sintaxe num arquivo de tradução não pode impedir um programa de rodar — a tradução é conforto, e o inglês é o piso"], ["a pasta de fora **vence** a de dentro", "é o que permite corrigir uma tradução sem reinstalar nada"], ["não há `en.py`", "seria uma cópia identidade de 115 entradas, que divergiria na primeira mensagem nova"]]}},
  ...
  {"h2": "O que isto não é"},
  {"list": ["**Não traduz as palavras da linguagem.** `given`, `cycle` e `action` são as mesmas em qualquer idioma — um programa escrito em espanhol não compilaria na máquina de quem escreve em português, e o código deixaria de ser portátil.", "**Não traduz a documentação.** Ela é escrita em pt-BR, e a tradução dela é outro trabalho.", "**Não há `Arcane.Idioma`.** Quem embute o DataForge e quer o texto traduzido chama `dataforge.idioma.traduzir` do lado do Python."]},
  {"cards": [{"href": "/docs/erros", "title": "Códigos de erro", "desc": "o catálogo, com o que fazer"}, {"href": "/docs/cli/referencia", "title": "A CLI", "desc": "`dataforge idioma` e os outros"}, {"href": "/docs/contribuir", "title": "Contribuir", "desc": "como mandar um catálogo"}]},
];

const headings = [{ id: 'os-tres-que-vem-de-fabrica', text: "Os três que vêm de fábrica", level: 2 as const }, { id: 'o-que-a-traducao-nao-toca', text: "O que a tradução NÃO toca", level: 2 as const }, { id: 'o-que-falta-sai-em-ingles', text: "O que falta sai em inglês", level: 2 as const }, { id: 'contribuir-um-idioma', text: "Contribuir um idioma", level: 2 as const }, { id: 'a-moldura-tambem-e-idioma', text: "A moldura também é idioma", level: 2 as const }, { id: 'o-que-isto-nao-e', text: "O que isto não é", level: 2 as const }];
