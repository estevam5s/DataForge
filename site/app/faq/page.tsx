...
const blocos: Bloco[] = [
  ...
  {"p": "A prova prática: um dos exercícios é um [interpretador de expressões escrito em DataForge](/receitas/interpretador), com lexer, parser e avaliador. A linguagem é expressiva o bastante para implementar outra."},
  ...
  {"p": "Depende do que \"produção\" significa no seu caso. O que existe e é testado: 236 testes, 180 exercícios, 42 exemplos, análise estática, servidor HTTP e SQLite funcionando."},
  ...
  {"p": "É um interpretador de árvore sem otimização, então mais lento que Python — que já é lento comparado a linguagens compiladas. Uma VM de bytecode está no [roadmap](/roadmap), mas ninguém reclamou de desempenho ainda."},
  {"p": "Veja [Desempenho](/faq/desempenho) para números e o que fazer a respeito."},
  {"h2": "Posso contribuir?"},
  {"p": "Sim — veja [Contribuir](/contribuir). Os itens mais acessíveis do roadmap: verificação de exaustividade em `match`, contrato de trait no analisador, funções novas nos módulos `Arcane.*` e mais exercícios."},
  {"h2": "Qual a licença?"},
  {"p": "MIT."},
];
