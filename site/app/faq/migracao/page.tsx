...
x := total // len(xs)  # 3.x e 4.0: divisão (chamada depois)` },
  ...
  {"h2": "O que é novo"},
  {"list": ["[Records](/fundamentos/records) e [enums](/fundamentos/enums)", "[Pattern matching estrutural](/fundamentos/pattern-matching) com guardas", "[Interpolação](/fundamentos/interpolacao) `$\"{x}\"`", "Ternário, `??`, `?.`, `in`/`not in`", "[Desestruturação](/fundamentos/desestruturacao), [spread](/fundamentos/spread), [compreensões](/fundamentos/compreensoes)", "[Generators](/fundamentos/generators) com `stream action` e `emit`", "[Análise estática](/tecnicas/analise-estatica) e stack traces", "Imports seletivos e `relay` funcional", "Sete módulos novos na [biblioteca](/biblioteca)", "Seis ferramentas: `check`, `test`, `fmt`, `lint`, `doc`, `init`"]},
