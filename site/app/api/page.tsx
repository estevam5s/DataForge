...
export const metadata: Metadata = {
  ...
  description: "Sete endpoints JSON com a linguagem inteira: sintaxe, 2223 símbolos, 65 comandos, 218 códigos de erro e o inventário. Gerados do código-fonte, com CORS aberto.",
};
