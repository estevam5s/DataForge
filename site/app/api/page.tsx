...
export const metadata: Metadata = {
  ...
  description: "Sete endpoints JSON com a linguagem inteira: sintaxe, 2353 símbolos, 69 comandos, 219 códigos de erro e o inventário. Gerados do código-fonte, com CORS aberto.",
};
