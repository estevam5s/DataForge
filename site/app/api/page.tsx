...
export const metadata: Metadata = {
  ...
  description: "Sete endpoints JSON com a linguagem inteira: sintaxe, 1687 símbolos, 45 comandos, 177 códigos de erro e o inventário. Gerados do código-fonte, com CORS aberto.",
};
