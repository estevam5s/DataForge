...
// A fonte e 'site/scripts/conteudo/api_publica.py' — mude la e rode o gerador.
...
export const metadata: Metadata = {
  ...
  description: "Sete endpoints JSON com a linguagem inteira: sintaxe, 2308 símbolos, 66 comandos, 219 códigos de erro e o inventário. Gerados do código-fonte, com CORS aberto.",
};
...
const blocos: Bloco[] = [
  ...
  {"h2": "`/api/erros.json`"},
  {"p": "Cada um dos 219 códigos com o que provoca e o que resolve:"},
  { code: `{
  "codigo": "DF0101",
...
const colorido = codigo.replace(palavras, '<b>$1</b>');`, lang: 'javascript' },
  {"h2": "Contrato"},
  {"table": {"head": ["", ""], "rows": [["**Método**", "`GET`. Não há escrita — é um site estático."], ["**Autenticação**", "nenhuma. Os dados são públicos e não há cota."], ["**CORS**", "`Access-Control-Allow-Origin: *` em todos os sete."], ["**Codificação**", "UTF-8, e o `Content-Type` diz `charset=utf-8`."], ["**Cache**", "revalidação a cada pedido. Um deploy publica dados novos na hora."], ["**Versão**", "todo arquivo traz `versao` na raiz — compare com a sua antes de confiar no formato."]]}},
...
doc := API.openapi(minha_api, {"titulo": "Loja", "versao": "2.0"})`, lang: 'df' },
  ...
  {"h2": "Onde continuar"},
  {"cards": [{"href": "/docs/tecnicas/api", "title": "OpenAPI", "desc": "O contrato da SUA API, gerado das rotas do Kiln."}, {"href": "/docs/biblioteca", "title": "Biblioteca Arcane", "meta": "2308 símbolos", "desc": "O mesmo que /api/modulos.json, para ler."}, {"href": "/docs/erros", "title": "Códigos de erro", "meta": "219", "desc": "O mesmo que /api/erros.json."}, {"href": "/docs/pacotes/registro", "title": "O registro", "desc": "Como publicar um pacote, e por que ele é estático."}]},
];
