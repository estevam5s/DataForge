...
const blocos: Bloco[] = [
  ...
  {"table": {"head": ["Verificação", "Resultado"], "rows": [["Testes unitários", "236 passando"], ["Exercícios", "180/180"], ["Exemplos", "42/42"], ["Análise estática sobre o repositório", "0 erros em 225 arquivos"], ["Formatador", "idempotente em 225 arquivos"], ["Módulos da stdlib", "20/20 carregam"], ["Instalação via pip", "funciona em venv limpo"]]}},
];
