...
nums.filter(lambda n: n % 2 is 1).map(lambda n: n * 2)` },
  {"table": {"head": ["Situação", "Prefira"], "rows": [["um filtro e uma transformação", "[compreensão](/fundamentos/compreensoes)"], ["três ou mais estágios", "pipeline"], ["termina com uma redução", "pipeline (`distill`)"], ["duas fontes combinadas", "compreensão"], ["lógica com vários passos ou efeitos", "laço `cycle`"]]}},
...
acima de 1000: [Ana, Carla]`, lang: 'text', title: `saída` },
  {"h2": "Com streams"},
  {"p": "Pipelines operam sobre listas em memória. Para fonte infinita ou arquivo grande, use [generators](/fundamentos/generators) — que avaliam sob demanda e depois entregam a lista ao pipeline:"},
