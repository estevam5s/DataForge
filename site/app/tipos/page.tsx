...
handle e:
  ...
  {"p": "Opcionais, mas **verificadas** — tanto em tempo de execução quanto pelo [analisador estático](/tecnicas/analise-estatica):"},
  { code: `idade: Integer := 30
nome: String := "Ana"
...
# quantidade: Integer := 3.5   # erro: 3.5 não é inteiro` },
  ...
  {"p": "A segunda comunica intenção. Aceitar `Any` não significa tratar tudo igual — o padrão é estreitar logo na entrada com [pattern matching](/fundamentos/pattern-matching):"},
