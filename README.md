...
(**Forge**) e **54 módulos** de biblioteca padrão com **1627 símbolos**.

[Instalação](#instalação) • [Tutorial](doc/TUTORIAL.md) • [Referência](doc/REFERENCIA.md) • [254 exercícios](exercicios/) • [Biblioteca](doc/BIBLIOTECA_PADRAO.md) • [Site](https://dataforge-lang.vercel.app) • [Roadmap](doc/ANALISE_E_ROADMAP.md)
...
| **Bateria inclusa** | 54 módulos com 1627 símbolos + 228 funções globais |
...
<!-- stdlib:inicio -->
54 módulos, 1627 símbolos, mais 228 funções globais sem import.
...
| `Arcane.Memoria` | 8 | O ciclo de vida visto de dentro: referência fraca, mapa fraco, ação ao descartar, coleta forçada, instâncias vivas por blueprint e tamanho aproximado. |
...
| [**doc/BIBLIOTECA_PADRAO.md**](doc/BIBLIOTECA_PADRAO.md) | assinaturas dos 54 módulos |
...
| [**exercicios/**](exercicios/) | 254 exercícios; os módulos 11-26 com `.md` explicativo |
...
| `dataforge/stdlib/` | os 54 módulos, incluindo o Kiln, o Crucible e o Forge | 8200 |
