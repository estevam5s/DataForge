...
(**Forge**) e **61 módulos** de biblioteca padrão com **1741 símbolos**.

[Instalação](#instalação) • [Tutorial](doc/TUTORIAL.md) • [Referência](doc/REFERENCIA.md) • [259 exercícios](exercicios/) • [Biblioteca](doc/BIBLIOTECA_PADRAO.md) • [Site](https://dataforge-lang.vercel.app) • [Roadmap](doc/ANALISE_E_ROADMAP.md)
...
| **Bateria inclusa** | 61 módulos com 1741 símbolos + 228 funções globais |
...
<!-- stdlib:inicio -->
61 módulos, 1741 símbolos, mais 228 funções globais sem import.
...
| [**doc/BIBLIOTECA_PADRAO.md**](doc/BIBLIOTECA_PADRAO.md) | assinaturas dos 61 módulos |
...
| [**exercicios/**](exercicios/) | 259 exercícios; os módulos 11-26 com `.md` explicativo |
...
| `dataforge/stdlib/` | os 61 módulos, incluindo o Kiln, o Crucible e o Forge | 8200 |
