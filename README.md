...
(**Forge**) e **40 módulos** de biblioteca padrão com **1390 símbolos**.
...
| **Bateria inclusa** | 40 módulos com 1390 símbolos + 228 funções globais |
...
<!-- stdlib:inicio -->
40 módulos, 1390 símbolos, mais 228 funções globais sem import.
