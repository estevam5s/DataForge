...
(**Forge**) e **54 módulos** de biblioteca padrão com **1623 símbolos**.
...
| **Bateria inclusa** | 54 módulos com 1623 símbolos + 228 funções globais |
...
<!-- stdlib:inicio -->
54 módulos, 1623 símbolos, mais 228 funções globais sem import.
