...
(**Forge**) e **54 módulos** de biblioteca padrão com **1625 símbolos**.
...
| **Bateria inclusa** | 54 módulos com 1625 símbolos + 228 funções globais |
...
<!-- stdlib:inicio -->
54 módulos, 1625 símbolos, mais 228 funções globais sem import.
