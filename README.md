...
(**Forge**) e **85 módulos** de biblioteca padrão com **2223 símbolos**.
...
| **Bateria inclusa** | 85 módulos com 2223 símbolos + 228 funções globais |
...
<!-- stdlib:inicio -->
85 módulos, 2223 símbolos, mais 231 funções globais sem import.
