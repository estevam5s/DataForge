...
(**Forge**) e **86 módulos** de biblioteca padrão com **2311 símbolos**.
...
| **Bateria inclusa** | 86 módulos com 2311 símbolos + 228 funções globais |
...
<!-- stdlib:inicio -->
86 módulos, 2311 símbolos, mais 231 funções globais sem import.
